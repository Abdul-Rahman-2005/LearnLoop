  ...
  public: {
    Tables: {
      pdf_ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "pdf_ratings_pdf_id_fkey"
            columns: ["pdf_id"]
            isOneToOne: false
      ...
      pdf_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "pdf_reports_pdf_id_fkey"
            columns: ["pdf_id"]
            isOneToOne: false
            referencedRelation: "pdfs"
            referencedColumns: ["id"]
    ...
    Functions: {
      increment_pdf_downloads: {
        Args: { pdf_uuid: string }
        Returns: undefined
      }
      increment_pdf_views: { Args: { pdf_uuid: string }; Returns: undefined }
    }
    Enums: {
      upload_status: "pending" | "approved" | "rejected"
      user_badge: "newcomer" | "contributor" | "expert" | "legend"
    }
    CompositeTypes: {
      [_ in never]: never
    }
